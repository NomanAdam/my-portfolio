 ...
 return (
  <div className="relative isolate min-h-screen overflow-x-hidden bg-[#111827]">
   ...
   <div className="absolute inset-0 -z-10 overflow-hidden">
    ...
    <div className="absolute top-[-1rem] left-[-35rem] h-[31.25rem] w-[50rem] rounded-full bg-[#676394] blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]" />
   </div>
